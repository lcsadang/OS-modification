...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 be 76 10 80 	movl   $0x801076be,(%esp)
...
80101eec:	e8 6f e4 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("dirlink");
80101ef1:	c7 04 24 76 76 10 80 	movl   $0x80107676,(%esp)
...
80102302:	81 fb c8 56 11 80    	cmp    $0x801156c8,%ebx
...
80102da7:	e8 84 29 00 00       	call   80105730 <idtinit>
...
80102e06:	80 
80102e07:	c7 04 24 c8 56 11 80 	movl   $0x801156c8,(%esp)
...
80102e40:	e8 9b 07 00 00       	call   801035e0 <pinit>
  tvinit();        // trap vectors
80102e45:	e8 46 28 00 00       	call   80105690 <tvinit>
  binit();         // buffer cache
...
801034e6:	81 fb 74 4e 11 80    	cmp    $0x80114e74,%ebx
...
801034f5:	a1 04 a0 10 80       	mov    0x8010a004,%eax
  ...
  release(&ptable.lock);
801034fa:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
...
80103511:	89 43 10             	mov    %eax,0x10(%ebx)
  ...
  release(&ptable.lock);
80103514:	e8 37 0f 00 00       	call   80104450 <release>
...
80103530:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103533:	c7 40 14 78 56 10 80 	movl   $0x80105678,0x14(%eax)
...
8010354d:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103550:	e8 4b 0f 00 00       	call   801044a0 <memset>
...
8010356f:	e8 dc 0e 00 00       	call   80104450 <release>
  p->context = (struct context*)sp;
  memset(p->context, 0, sizeof *p->context);
  p->context->eip = (uint)forkret;
...
8010359d:	e8 ae 0e 00 00       	call   80104450 <release>
...
801035f5:	e8 76 0c 00 00       	call   80104270 <initlock>
}
801035fa:	c9                   	leave  
801035fb:	c3                   	ret    
...
mycpu(void)
{
  ...
  if(readeflags()&FL_IF)
    panic("mycpu called with interrupts enabled\n");
80103666:	c7 04 24 20 75 10 80 	movl   $0x80107520,(%esp)
...
801036a4:	83 ec 04             	sub    $0x4,%esp
  ...
  struct proc *p;
  pushcli();
801036a7:	e8 44 0c 00 00       	call   801042f0 <pushcli>
  c = mycpu();
801036ac:	e8 4f ff ff ff       	call   80103600 <mycpu>
  p = c->proc;
801036b1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801036b7:	e8 74 0c 00 00       	call   80104330 <popcli>
  return p;
}
...
801036e3:	e8 08 35 00 00       	call   80106bf0 <setupkvm>
...
80103705:	80 
80103706:	e8 15 32 00 00       	call   80106920 <inituvm>
  p->sz = PGSIZE;
...
80103727:	e8 74 0d 00 00       	call   801044a0 <memset>
...
8010378e:	e8 ed 0e 00 00       	call   80104680 <safestrcpy>
  p->cwd = namei("/");
...
801037a9:	e8 32 0c 00 00       	call   801043e0 <acquire>
...
801037bc:	e8 8f 0c 00 00       	call   80104450 <release>
}
...
80103809:	e8 52 32 00 00       	call   80106a60 <allocuvm>
...
80103817:	e8 f4 2f 00 00       	call   80106810 <switchuvm>
  return 0;
...
8010383a:	e8 11 33 00 00       	call   80106b50 <deallocuvm>
...
8010387e:	e8 4d 34 00 00       	call   80106cd0 <copyuvm>
...
801038fd:	e8 7e 0d 00 00       	call   80104680 <safestrcpy>
...
8010390c:	e8 cf 0a 00 00       	call   801043e0 <acquire>
...
8010391f:	e8 2c 0b 00 00       	call   80104450 <release>
...
80103988:	bb 74 2d 11 80       	mov    $0x80112d74,%ebx
  for(;;){
    ...
    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
8010398d:	e8 4e 0a 00 00       	call   801043e0 <acquire>
80103992:	eb 1f                	jmp    801039b3 <scheduler+0x53>
80103994:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
      if(p->state != RUNNABLE || p->scarletcount > 0){
        if (p->scarletcount > 0){
80103998:	85 c0                	test   %eax,%eax
8010399a:	7e 09                	jle    801039a5 <scheduler+0x45>
		p->scarletcount--;}
8010399c:	83 e8 01             	sub    $0x1,%eax
8010399f:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
    // Enable interrupts on this processor.
    sti();
...
801039ab:	81 fb 74 4e 11 80    	cmp    $0x80114e74,%ebx
801039b1:	74 5d                	je     80103a10 <scheduler+0xb0>
      if(p->state != RUNNABLE || p->scarletcount > 0){
801039b3:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
        if (p->scarletcount > 0){
801039b7:	8b 83 80 00 00 00    	mov    0x80(%ebx),%eax
    sti();
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
      if(p->state != RUNNABLE || p->scarletcount > 0){
801039bd:	75 d9                	jne    80103998 <scheduler+0x38>
801039bf:	85 c0                	test   %eax,%eax
801039c1:	7f d9                	jg     8010399c <scheduler+0x3c>
	continue;
      }
      ...
      c->proc = p;
801039c3:	89 9e ac 00 00 00    	mov    %ebx,0xac(%esi)
      switchuvm(p);
801039c9:	89 1c 24             	mov    %ebx,(%esp)
801039cc:	e8 3f 2e 00 00       	call   80106810 <switchuvm>
      p->state = RUNNING;
      if (enabled == 1){      
801039d1:	83 3d 20 2d 11 80 01 	cmpl   $0x1,0x80112d20
      // Switch to chosen process.  It is the process's job
      // to release ptable.lock and then reacquire it
      // before jumping back to us.
      c->proc = p;
      switchuvm(p);
      p->state = RUNNING;
801039d8:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      if (enabled == 1){      
801039df:	74 47                	je     80103a28 <scheduler+0xc8>
	p->count++;}
...
801039e1:	8b 43 1c             	mov    0x1c(%ebx),%eax
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801039e4:	81 c3 84 00 00 00    	add    $0x84,%ebx
      switchuvm(p);
      p->state = RUNNING;
      if (enabled == 1){      
	p->count++;}
...
801039f1:	e8 e5 0c 00 00       	call   801046db <swtch>
      switchkvm();
801039f6:	e8 f5 2d 00 00       	call   801067f0 <switchkvm>
    // Enable interrupts on this processor.
    sti();
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801039fb:	81 fb 74 4e 11 80    	cmp    $0x80114e74,%ebx
      swtch(&(c->scheduler), p->context);
      switchkvm();
...
80103a08:	00 00 00 
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a0b:	75 a6                	jne    801039b3 <scheduler+0x53>
...
80103a17:	e8 34 0a 00 00       	call   80104450 <release>

  }
80103a1c:	e9 5f ff ff ff       	jmp    80103980 <scheduler+0x20>
80103a21:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      ...
      if (enabled == 1){      
	p->count++;}
80103a28:	83 43 7c 01          	addl   $0x1,0x7c(%ebx)
80103a2c:	eb b3                	jmp    801039e1 <scheduler+0x81>
...
80103a38:	e8 63 fc ff ff       	call   801036a0 <myproc>

  if(!holding(&ptable.lock))
80103a3d:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
// there's no process.
void
sched(void)
{
...
80103a44:	89 c3                	mov    %eax,%ebx
  ...
  if(!holding(&ptable.lock))
80103a46:	e8 55 09 00 00       	call   801043a0 <holding>
80103a4b:	85 c0                	test   %eax,%eax
80103a4d:	74 4f                	je     80103a9e <sched+0x6e>
    panic("sched ptable.lock");
  if(mycpu()->ncli != 1)
80103a4f:	e8 ac fb ff ff       	call   80103600 <mycpu>
...
80103a68:	75 40                	jne    80103aaa <sched+0x7a>
  ...
  intena = mycpu()->intena;
80103a6a:	e8 91 fb ff ff       	call   80103600 <mycpu>
...
80103a72:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103a78:	e8 83 fb ff ff       	call   80103600 <mycpu>
80103a7d:	8b 40 04             	mov    0x4(%eax),%eax
80103a80:	89 1c 24             	mov    %ebx,(%esp)
80103a83:	89 44 24 04          	mov    %eax,0x4(%esp)
80103a87:	e8 4f 0c 00 00       	call   801046db <swtch>
  mycpu()->intena = intena;
80103a8c:	e8 6f fb ff ff       	call   80103600 <mycpu>
...
80103a9d:	c3                   	ret    
{
  ...
  if(!holding(&ptable.lock))
    panic("sched ptable.lock");
80103a9e:	c7 04 24 30 74 10 80 	movl   $0x80107430,(%esp)
80103aa5:	e8 b6 c8 ff ff       	call   80100360 <panic>
  ...
  if(readeflags()&FL_IF)
    panic("sched interruptible");
80103aaa:	c7 04 24 5c 74 10 80 	movl   $0x8010745c,(%esp)
80103ab1:	e8 aa c8 ff ff       	call   80100360 <panic>
  ...
  if(p->state == RUNNING)
    panic("sched running");
80103ab6:	c7 04 24 4e 74 10 80 	movl   $0x8010744e,(%esp)
80103abd:	e8 9e c8 ff ff       	call   80100360 <panic>
  ...
  if(mycpu()->ncli != 1)
    panic("sched locks");
80103ac2:	c7 04 24 42 74 10 80 	movl   $0x80107442,(%esp)
...
80103ad7:	83 ec 10             	sub    $0x10,%esp
  struct proc *curproc = myproc();
80103ada:	e8 c1 fb ff ff       	call   801036a0 <myproc>
  struct proc *p;
  int fd;
...
80103afb:	e8 30 d3 ff ff       	call   80100e30 <fileclose>
      curproc->ofile[fd] = 0;
...
80103b0e:	75 e0                	jne    80103af0 <exit+0x20>
  ...
  begin_op();
80103b10:	e8 fb ef ff ff       	call   80102b10 <begin_op>
  iput(curproc->cwd);
80103b15:	8b 43 68             	mov    0x68(%ebx),%eax
80103b18:	89 04 24             	mov    %eax,(%esp)
80103b1b:	e8 b0 dc ff ff       	call   801017d0 <iput>
  end_op();
80103b20:	e8 5b f0 ff ff       	call   80102b80 <end_op>
  curproc->cwd = 0;
80103b25:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)

  acquire(&ptable.lock);
80103b2c:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80103b33:	e8 a8 08 00 00       	call   801043e0 <acquire>
...
80103b6e:	81 fa 74 4e 11 80    	cmp    $0x80114e74,%edx
...
80103b7b:	b9 74 2d 11 80       	mov    $0x80112d74,%ecx
...
80103b8e:	81 f9 74 4e 11 80    	cmp    $0x80114e74,%ecx
...
80103ba4:	ba 74 2d 11 80       	mov    $0x80112d74,%edx
...
80103bb6:	81 fa 74 4e 11 80    	cmp    $0x80114e74,%edx
...
80103bd9:	e8 52 fe ff ff       	call   80103a30 <sched>
  panic("zombie exit");
80103bde:	c7 04 24 7d 74 10 80 	movl   $0x8010747d,(%esp)
80103be5:	e8 76 c7 ff ff       	call   80100360 <panic>
  ...
  if(curproc == initproc)
    panic("init exiting");
80103bea:	c7 04 24 70 74 10 80 	movl   $0x80107470,(%esp)
...
80103c06:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80103c0d:	e8 ce 07 00 00       	call   801043e0 <acquire>
...
80103c1e:	e8 0d fe ff ff       	call   80103a30 <sched>
  release(&ptable.lock);
80103c23:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80103c2a:	e8 21 08 00 00       	call   80104450 <release>
}
80103c2f:	c9                   	leave  
80103c30:	c3                   	ret    
...
80103c62:	81 fe 40 2d 11 80    	cmp    $0x80112d40,%esi
80103c68:	74 46                	je     80103cb0 <sleep+0x70>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103c6a:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80103c71:	e8 6a 07 00 00       	call   801043e0 <acquire>
    release(lk);
80103c76:	89 34 24             	mov    %esi,(%esp)
80103c79:	e8 d2 07 00 00       	call   80104450 <release>
  }
  // Go to sleep.
  p->chan = chan;
...
80103c8d:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
80103c94:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80103c9b:	e8 b0 07 00 00       	call   80104450 <release>
    acquire(lk);
...
80103ca9:	5d                   	pop    %ebp
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
    acquire(lk);
80103caa:	e9 31 07 00 00       	jmp    801043e0 <acquire>
80103caf:	90                   	nop
  if(lk != &ptable.lock){  //DOC: sleeplock0
    acquire(&ptable.lock);  //DOC: sleeplock1
    release(lk);
...
80103cf8:	e8 a3 f9 ff ff       	call   801036a0 <myproc>
  ...
  acquire(&ptable.lock);
80103cfd:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
int
wait(void)
{
  struct proc *p;
...
80103d37:	b8 01 00 00 00       	mov    $0x1,%eax
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d3c:	81 fb 74 4e 11 80    	cmp    $0x80114e74,%ebx
...
80103d53:	c7 44 24 04 40 2d 11 	movl   $0x80112d40,0x4(%esp)
80103d5a:	80 
...
80103d6e:	e8 7d e5 ff ff       	call   801022f0 <kfree>
        p->kstack = 0;
        freevm(p->pgdir);
...
80103d80:	e8 eb 2d 00 00       	call   80106b70 <freevm>
        p->pid = 0;
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
        p->state = UNUSED;
        release(&ptable.lock);
80103d85:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
        // Found one.
        pid = p->pid;
        kfree(p->kstack);
        p->kstack = 0;
...
80103da5:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103dac:	e8 9f 06 00 00       	call   80104450 <release>
    }
...
80103db9:	c3                   	ret    
    ...
    if(!havekids || curproc->killed){
      release(&ptable.lock);
80103dba:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80103dc1:	e8 8a 06 00 00       	call   80104450 <release>
    }
...
80103df1:	e8 ea 05 00 00       	call   801043e0 <acquire>
static void
wakeup1(void *chan)
{
  struct proc *p;
...
80103e05:	3d 74 4e 11 80       	cmp    $0x80114e74,%eax
...
80103e23:	3d 74 4e 11 80       	cmp    $0x80114e74,%eax
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103e30:	c7 45 08 40 2d 11 80 	movl   $0x80112d40,0x8(%ebp)
}
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103e3c:	e9 0f 06 00 00       	jmp    80104450 <release>
...
80103e61:	e8 7a 05 00 00       	call   801043e0 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103e75:	3d 74 4e 11 80       	cmp    $0x80114e74,%eax
...
80103e95:	e8 b6 05 00 00       	call   80104450 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80103eb1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  release(&ptable.lock);
80103eb8:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80103ebf:	e8 8c 05 00 00       	call   80104450 <release>
  return -1;
}
...
80103ed6:	bb e0 2d 11 80       	mov    $0x80112de0,%ebx
...
80103ee4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103ee8:	c7 04 24 be 76 10 80 	movl   $0x801076be,(%esp)
...
80103ef4:	81 c3 84 00 00 00    	add    $0x84,%ebx
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103efa:	81 fb e0 4e 11 80    	cmp    $0x80114ee0,%ebx
...
80103f0d:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
80103f10:	ba a0 74 10 80       	mov    $0x801074a0,%edx
  uint pc[10];
...
80103f17:	8b 14 85 6c 75 10 80 	mov    -0x7fef8a94(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
80103f1e:	b8 a0 74 10 80       	mov    $0x801074a0,%eax
...
80103f33:	c7 04 24 a4 74 10 80 	movl   $0x801074a4,(%esp)
...
80103f5f:	e8 2c 03 00 00       	call   80104290 <getcallerpcs>
...
80103f79:	c7 04 24 e1 6e 10 80 	movl   $0x80106ee1,(%esp)
...
80103fa3:	89 e5                	mov    %esp,%ebp
	enabled = 1;
80103fa5:	c7 05 20 2d 11 80 01 	movl   $0x1,0x80112d20
80103fac:	00 00 00 
	return 0;
}
80103faf:	5d                   	pop    %ebp
80103fb0:	c3                   	ret    
80103fb1:	eb 0d                	jmp    80103fc0 <disablecount>
80103fb3:	90                   	nop
80103fb4:	90                   	nop
80103fb5:	90                   	nop
80103fb6:	90                   	nop
...
80103fc3:	89 e5                	mov    %esp,%ebp
	enabled = 0;
80103fc5:	c7 05 20 2d 11 80 00 	movl   $0x0,0x80112d20
80103fcc:	00 00 00 
	return 0;
}
80103fcf:	5d                   	pop    %ebp
80103fd0:	c3                   	ret    
80103fd1:	eb 0d                	jmp    80103fe0 <resetcount>
80103fd3:	90                   	nop
80103fd4:	90                   	nop
80103fd5:	90                   	nop
80103fd6:	90                   	nop
...
80103fe3:	83 ec 18             	sub    $0x18,%esp
	struct proc *p;
	acquire(&ptable.lock);
80103fe6:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80103fed:	e8 ee 03 00 00       	call   801043e0 <acquire>
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ff2:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
80103ff7:	90                   	nop
		p->count = 0;
80103ff8:	c7 40 7c 00 00 00 00 	movl   $0x0,0x7c(%eax)
...
resetcount(void){
	...
	acquire(&ptable.lock);
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fff:	05 84 00 00 00       	add    $0x84,%eax
80104004:	3d 74 4e 11 80       	cmp    $0x80114e74,%eax
80104009:	75 ed                	jne    80103ff8 <resetcount+0x18>
		p->count = 0;
	}
	release(&ptable.lock);
8010400b:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80104012:	e8 39 04 00 00       	call   80104450 <release>
	return 0;
}
80104017:	31 c0                	xor    %eax,%eax
80104019:	c9                   	leave  
8010401a:	c3                   	ret    
8010401b:	90                   	nop
...
80104024:	bb e0 2d 11 80       	mov    $0x80112de0,%ebx
80104029:	83 ec 44             	sub    $0x44,%esp
        struct proc *p;
        const char *getstate[] = { "UNUSED  ", "EMBRYO  ", "SLEEPING", "RUNNABLE", "RUNNING ", "ZOMBIE  " };
        acquire(&ptable.lock);
8010402c:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
}
...
ps(void){
        struct proc *p;
        const char *getstate[] = { "UNUSED  ", "EMBRYO  ", "SLEEPING", "RUNNABLE", "RUNNING ", "ZOMBIE  " };
80104033:	c7 45 e0 ad 74 10 80 	movl   $0x801074ad,-0x20(%ebp)
8010403a:	c7 45 e4 b6 74 10 80 	movl   $0x801074b6,-0x1c(%ebp)
80104041:	c7 45 e8 bf 74 10 80 	movl   $0x801074bf,-0x18(%ebp)
80104048:	c7 45 ec c8 74 10 80 	movl   $0x801074c8,-0x14(%ebp)
8010404f:	c7 45 f0 d1 74 10 80 	movl   $0x801074d1,-0x10(%ebp)
80104056:	c7 45 f4 da 74 10 80 	movl   $0x801074da,-0xc(%ebp)
        acquire(&ptable.lock);
8010405d:	e8 7e 03 00 00       	call   801043e0 <acquire>
	cprintf("PID  	STATE   	COUNT	SCARLET	NAME\n");
80104062:	c7 04 24 48 75 10 80 	movl   $0x80107548,(%esp)
80104069:	e8 e2 c5 ff ff       	call   80100650 <cprintf>
8010406e:	eb 0e                	jmp    8010407e <ps+0x5e>
80104070:	81 c3 84 00 00 00    	add    $0x84,%ebx
        for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104076:	81 fb e0 4e 11 80    	cmp    $0x80114ee0,%ebx
8010407c:	74 45                	je     801040c3 <ps+0xa3>
                if(p->state != UNUSED){
8010407e:	8b 43 a0             	mov    -0x60(%ebx),%eax
80104081:	85 c0                	test   %eax,%eax
80104083:	74 eb                	je     80104070 <ps+0x50>

                        cprintf("%d	%s	%d	%d	%s\n", p->pid, getstate[p->state], p->count, p->scarletcount, p->name);
80104085:	8b 53 14             	mov    0x14(%ebx),%edx
80104088:	8b 44 85 e0          	mov    -0x20(%ebp,%eax,4),%eax
8010408c:	89 5c 24 14          	mov    %ebx,0x14(%esp)
80104090:	81 c3 84 00 00 00    	add    $0x84,%ebx
80104096:	c7 04 24 e3 74 10 80 	movl   $0x801074e3,(%esp)
8010409d:	89 54 24 10          	mov    %edx,0x10(%esp)
801040a1:	8b 53 8c             	mov    -0x74(%ebx),%edx
801040a4:	89 44 24 08          	mov    %eax,0x8(%esp)
801040a8:	8b 83 20 ff ff ff    	mov    -0xe0(%ebx),%eax
801040ae:	89 54 24 0c          	mov    %edx,0xc(%esp)
801040b2:	89 44 24 04          	mov    %eax,0x4(%esp)
801040b6:	e8 95 c5 ff ff       	call   80100650 <cprintf>
ps(void){
        struct proc *p;
        const char *getstate[] = { "UNUSED  ", "EMBRYO  ", "SLEEPING", "RUNNABLE", "RUNNING ", "ZOMBIE  " };
        acquire(&ptable.lock);
	cprintf("PID  	STATE   	COUNT	SCARLET	NAME\n");
        for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040bb:	81 fb e0 4e 11 80    	cmp    $0x80114ee0,%ebx
801040c1:	75 bb                	jne    8010407e <ps+0x5e>
                if(p->state != UNUSED){
	...
	release(&ptable.lock);
801040c3:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
801040ca:	e8 81 03 00 00       	call   80104450 <release>
        return 0;
}
801040cf:	83 c4 44             	add    $0x44,%esp
...
int 
scarlet(int scarletpid, int notrun){
...
801040e8:	8b 5d 08             	mov    0x8(%ebp),%ebx
	struct proc *p;
	acquire(&ptable.lock);
801040eb:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
	release(&ptable.lock);
        return 0;
}
...
int 
scarlet(int scarletpid, int notrun){
801040f2:	8b 75 0c             	mov    0xc(%ebp),%esi
	struct proc *p;
	acquire(&ptable.lock);
801040f5:	e8 e6 02 00 00       	call   801043e0 <acquire>
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040fa:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
801040ff:	eb 13                	jmp    80104114 <scarlet+0x34>
80104101:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104108:	05 84 00 00 00       	add    $0x84,%eax
8010410d:	3d 74 4e 11 80       	cmp    $0x80114e74,%eax
80104112:	74 17                	je     8010412b <scarlet+0x4b>
		if (p->pid == scarletpid){
80104114:	39 58 10             	cmp    %ebx,0x10(%eax)
80104117:	75 ef                	jne    80104108 <scarlet+0x28>
			p->scarletcount = notrun;
80104119:	89 b0 80 00 00 00    	mov    %esi,0x80(%eax)
...
scarlet(int scarletpid, int notrun){
	...
	acquire(&ptable.lock);
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010411f:	05 84 00 00 00       	add    $0x84,%eax
80104124:	3d 74 4e 11 80       	cmp    $0x80114e74,%eax
80104129:	75 e9                	jne    80104114 <scarlet+0x34>
		if (p->pid == scarletpid){
			p->scarletcount = notrun;
		}
	}
	release(&ptable.lock);
8010412b:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80104132:	e8 19 03 00 00       	call   80104450 <release>
	return 0;
}	
...
8010414a:	c7 44 24 04 84 75 10 	movl   $0x80107584,0x4(%esp)
80104151:	80 
...
801041a7:	e8 94 fa ff ff       	call   80103c40 <sleep>
...
801041b2:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801041b8:	e8 e3 f4 ff ff       	call   801036a0 <myproc>
...
80104206:	e8 d5 fb ff ff       	call   80103de0 <wakeup>
  release(&lk->lk);
...
80104242:	e8 59 f4 ff ff       	call   801036a0 <myproc>
...
8010433b:	75 49                	jne    80104386 <popcli+0x56>
  ...
  if(--mycpu()->ncli < 0)
8010433d:	e8 be f2 ff ff       	call   80103600 <mycpu>
...
80104355:	e8 a6 f2 ff ff       	call   80103600 <mycpu>
...
80104366:	66 90                	xchg   %ax,%ax
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104368:	e8 93 f2 ff ff       	call   80103600 <mycpu>
...
popcli(void)
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
8010437a:	c7 04 24 a6 75 10 80 	movl   $0x801075a6,(%esp)
...
popcli(void)
{
  if(readeflags()&FL_IF)
    panic("popcli - interruptible");
80104386:	c7 04 24 8f 75 10 80 	movl   $0x8010758f,(%esp)
...
801043b8:	e8 43 f2 ff ff       	call   80103600 <mycpu>
...
80104414:	e8 e7 f1 ff ff       	call   80103600 <mycpu>
...
8010442c:	e8 5f fe ff ff       	call   80104290 <getcallerpcs>
}
...
acquire(struct spinlock *lk)
{
  ...
  if(holding(lk))
    panic("acquire");
80104437:	c7 04 24 ad 75 10 80 	movl   $0x801075ad,(%esp)
8010443e:	e8 1d bf ff ff       	call   80100360 <panic>
...
80104464:	74 23                	je     80104489 <release+0x39>
    panic("release");
...
80104479:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)

  popcli();
}
8010447f:	83 c4 14             	add    $0x14,%esp
80104482:	5b                   	pop    %ebx
80104483:	5d                   	pop    %ebp
  // Release the lock, equivalent to lk->locked = 0.
  // This code can't use a C assignment, since it might
  ...
  popcli();
80104484:	e9 a7 fe ff ff       	jmp    80104330 <popcli>
// Release the lock.
void
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
80104489:	c7 04 24 b5 75 10 80 	movl   $0x801075b5,(%esp)
80104490:	e8 cb be ff ff       	call   80100360 <panic>
...
801046f7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801046fa:	e8 a1 ef ff ff       	call   801036a0 <myproc>
...
80104737:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010473a:	e8 61 ef ff ff       	call   801036a0 <myproc>
...
8010479b:	e8 00 ef ff ff       	call   801036a0 <myproc>
...
801047c8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801047cb:	e8 d0 ee ff ff       	call   801036a0 <myproc>
...
80104865:	83 ec 10             	sub    $0x10,%esp
  int num;
  struct proc *curproc = myproc();
80104868:	e8 33 ee ff ff       	call   801036a0 <myproc>
...
80104878:	83 fa 1a             	cmp    $0x1a,%edx
8010487b:	77 1b                	ja     80104898 <syscall+0x38>
8010487d:	8b 14 85 e0 75 10 80 	mov    -0x7fef8a20(,%eax,4),%edx
...
801048a6:	c7 04 24 bd 75 10 80 	movl   $0x801075bd,(%esp)
...
80104a30:	c7 44 24 04 6c 76 10 	movl   $0x8010766c,0x4(%esp)
80104a37:	80 
...
80104a4b:	c7 44 24 04 6b 76 10 	movl   $0x8010766b,0x4(%esp)
80104a52:	80 
...
80104a61:	79 89                	jns    801049ec <create+0xdc>
      panic("create dots");
80104a63:	c7 04 24 5f 76 10 80 	movl   $0x8010765f,(%esp)
80104a6a:	e8 f1 b8 ff ff       	call   80100360 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
80104a6f:	c7 04 24 6e 76 10 80 	movl   $0x8010766e,(%esp)
80104a76:	e8 e5 b8 ff ff       	call   80100360 <panic>
  ...
  if((ip = ialloc(dp->dev, type)) == 0)
    panic("create: ialloc");
80104a7b:	c7 04 24 50 76 10 80 	movl   $0x80107650,(%esp)
...
80104ab9:	e8 e2 eb ff ff       	call   801036a0 <myproc>
...
80104c33:	78 23                	js     80104c58 <sys_close+0x38>
    return -1;
  myproc()->ofile[fd] = 0;
80104c35:	e8 66 ea ff ff       	call   801036a0 <myproc>
...
80104e21:	c7 44 24 04 6c 76 10 	movl   $0x8010766c,0x4(%esp)
80104e28:	80 
...
80104e39:	c7 44 24 04 6b 76 10 	movl   $0x8010766b,0x4(%esp)
80104e40:	80 
...
80104f88:	e9 48 ff ff ff       	jmp    80104ed5 <sys_unlink+0x105>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
80104f8d:	c7 04 24 90 76 10 80 	movl   $0x80107690,(%esp)
80104f94:	e8 c7 b3 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("unlink: writei");
80104f99:	c7 04 24 a2 76 10 80 	movl   $0x801076a2,(%esp)
80104fa0:	e8 bb b3 ff ff       	call   80100360 <panic>
  ...
  if(ip->nlink < 1)
    panic("unlink: nlink < 1");
80104fa5:	c7 04 24 7e 76 10 80 	movl   $0x8010767e,(%esp)
...
801051f5:	83 ec 20             	sub    $0x20,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801051f8:	e8 a3 e4 ff ff       	call   801036a0 <myproc>
...
{
  return fork();
80105414:	e9 37 e4 ff ff       	jmp    80103850 <fork>
...
80105423:	83 ec 08             	sub    $0x8,%esp
  exit();
80105426:	e8 a5 e6 ff ff       	call   80103ad0 <exit>
...
{
  return wait();
80105434:	e9 b7 e8 ff ff       	jmp    80103cf0 <wait>
...
80105463:	e8 e8 e9 ff ff       	call   80103e50 <kill>
}
80105468:	c9                   	leave  
80105469:	c3                   	ret    
...
801054fc:	78 7e                	js     8010557c <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
801054fe:	c7 04 24 80 4e 11 80 	movl   $0x80114e80,(%esp)
80105505:	e8 d6 ee ff ff       	call   801043e0 <acquire>
  ticks0 = ticks;
...
8010550a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ...
  acquire(&tickslock);
  ticks0 = ticks;
8010550d:	8b 1d c0 56 11 80    	mov    0x801156c0,%ebx
  while(ticks - ticks0 < n){
...
80105520:	c7 44 24 04 80 4e 11 	movl   $0x80114e80,0x4(%esp)
80105527:	80 
80105528:	c7 04 24 c0 56 11 80 	movl   $0x801156c0,(%esp)
8010552f:	e8 0c e7 ff ff       	call   80103c40 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105534:	a1 c0 56 11 80       	mov    0x801156c0,%eax
...
8010554a:	74 d4                	je     80105520 <sys_sleep+0x40>
      release(&tickslock);
8010554c:	c7 04 24 80 4e 11 80 	movl   $0x80114e80,(%esp)
...
80105564:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  release(&tickslock);
80105568:	c7 04 24 80 4e 11 80 	movl   $0x80114e80,(%esp)
...
80105594:	83 ec 14             	sub    $0x14,%esp
  ...
  acquire(&tickslock);
80105597:	c7 04 24 80 4e 11 80 	movl   $0x80114e80,(%esp)
8010559e:	e8 3d ee ff ff       	call   801043e0 <acquire>
  xticks = ticks;
801055a3:	8b 1d c0 56 11 80    	mov    0x801156c0,%ebx
  release(&tickslock);
801055a9:	c7 04 24 80 4e 11 80 	movl   $0x80114e80,(%esp)
...
801055c3:	83 ec 18             	sub    $0x18,%esp
	cprintf("Hello, world!\n");
801055c6:	c7 04 24 b1 76 10 80 	movl   $0x801076b1,(%esp)
801055cd:	e8 7e b0 ff ff       	call   80100650 <cprintf>
...
801055e0 <sys_enablecount>:

int
sys_enablecount(void){
...
sys_enablecount(void){
	return enablecount();
801055e4:	e9 b7 e9 ff ff       	jmp    80103fa0 <enablecount>
801055e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

801055f0 <sys_disablecount>:
}

int
sys_disablecount(void){
...
sys_disablecount(void){
	return disablecount();
801055f4:	e9 c7 e9 ff ff       	jmp    80103fc0 <disablecount>
801055f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105600 <sys_resetcount>:
}
...
sys_resetcount(void){
	return resetcount();
80105604:	e9 d7 e9 ff ff       	jmp    80103fe0 <resetcount>
...
sys_ps(void){
	return ps();
80105614:	e9 07 ea ff ff       	jmp    80104020 <ps>
80105619:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105620 <sys_scarlet>:
}
...
80105634:	e8 57 f1 ff ff       	call   80104790 <argint>
	argint(1, &notrun);
80105639:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010563c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105640:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105647:	e8 44 f1 ff ff       	call   80104790 <argint>
	return scarlet(scarletpid, notrun);
...
80105659:	e8 82 ea ff ff       	call   801040e0 <scarlet>
}
8010565e:	c9                   	leave  
8010565f:	c3                   	ret    
...
80105661:	06                   	push   %es
  pushl %fs
80105662:	0f a0                	push   %fs
  pushl %gs
80105664:	0f a8                	push   %gs
  pushal
80105666:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105667:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
8010566b:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010566d:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
8010566f:	54                   	push   %esp
  call trap
80105670:	e8 eb 00 00 00       	call   80105760 <trap>
  addl $4, %esp
80105675:	83 c4 04             	add    $0x4,%esp
...
80105678:	61                   	popa   
  popl %gs
80105679:	0f a9                	pop    %gs
  popl %fs
8010567b:	0f a1                	pop    %fs
  popl %es
8010567d:	07                   	pop    %es
  popl %ds
8010567e:	1f                   	pop    %ds
...
801056a4:	66 89 0c c5 c2 4e 11 	mov    %cx,-0x7feeb13e(,%eax,8)
801056ab:	80 
801056ac:	c6 04 c5 c4 4e 11 80 	movb   $0x0,-0x7feeb13c(,%eax,8)
801056b3:	00 
801056b4:	c6 04 c5 c5 4e 11 80 	movb   $0x8e,-0x7feeb13b(,%eax,8)
801056bb:	8e 
801056bc:	66 89 14 c5 c0 4e 11 	mov    %dx,-0x7feeb140(,%eax,8)
801056c3:	80 
801056c4:	c1 ea 10             	shr    $0x10,%edx
801056c7:	66 89 14 c5 c6 4e 11 	mov    %dx,-0x7feeb13a(,%eax,8)
801056ce:	80 
void
tvinit(void)
{
...
801056e9:	c7 44 24 04 c0 76 10 	movl   $0x801076c0,0x4(%esp)
801056f0:	80 
801056f1:	c7 04 24 80 4e 11 80 	movl   $0x80114e80,(%esp)
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801056f8:	66 89 15 c2 50 11 80 	mov    %dx,0x801150c2
801056ff:	66 a3 c0 50 11 80    	mov    %ax,0x801150c0
80105705:	c1 e8 10             	shr    $0x10,%eax
80105708:	c6 05 c4 50 11 80 00 	movb   $0x0,0x801150c4
8010570f:	c6 05 c5 50 11 80 ef 	movb   $0xef,0x801150c5
80105716:	66 a3 c6 50 11 80    	mov    %ax,0x801150c6

  initlock(&tickslock, "time");
8010571c:	e8 4f eb ff ff       	call   80104270 <initlock>
}
80105721:	c9                   	leave  
80105722:	c3                   	ret    
...
8010573b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010573f:	b8 c0 4e 11 80       	mov    $0x80114ec0,%eax
...
80105788:	e8 13 df ff ff       	call   801036a0 <myproc>
8010578d:	85 c0                	test   %eax,%eax
8010578f:	90                   	nop
80105790:	0f 84 fa 01 00 00    	je     80105990 <trap+0x230>
80105796:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
8010579a:	0f 84 f0 01 00 00    	je     80105990 <trap+0x230>
...
801057ac:	e8 cf de ff ff       	call   80103680 <cpuid>
...
801057f3:	c7 04 24 24 77 10 80 	movl   $0x80107724,(%esp)
...
801057fe:	e8 4d ae ff ff       	call   80100650 <cprintf>
    ...
    myproc()->killed = 1;
80105803:	e8 98 de ff ff       	call   801036a0 <myproc>
...
80105825:	e8 76 de ff ff       	call   801036a0 <myproc>
...
80105839:	74 4d                	je     80105888 <trap+0x128>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010583b:	e8 60 de ff ff       	call   801036a0 <myproc>
80105840:	85 c0                	test   %eax,%eax
80105842:	74 1d                	je     80105861 <trap+0x101>
80105844:	e8 57 de ff ff       	call   801036a0 <myproc>
...
8010587b:	75 a8                	jne    80105825 <trap+0xc5>
    exit();
8010587d:	e8 4e e2 ff ff       	call   80103ad0 <exit>
80105882:	eb a1                	jmp    80105825 <trap+0xc5>
80105884:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105888:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
8010588c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105890:	75 a9                	jne    8010583b <trap+0xdb>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
80105892:	e8 69 e3 ff ff       	call   80103c00 <yield>
80105897:	eb a2                	jmp    8010583b <trap+0xdb>
80105899:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
801058a0:	e8 db dd ff ff       	call   80103680 <cpuid>
801058a5:	85 c0                	test   %eax,%eax
801058a7:	0f 84 b3 00 00 00    	je     80105960 <trap+0x200>
801058ad:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
    lapiceoi();
801058b0:	e8 cb ce ff ff       	call   80102780 <lapiceoi>
    break;
...
801058cf:	90                   	nop
  case T_IRQ0 + IRQ_COM1:
    uartintr();
801058d0:	e8 1b 02 00 00       	call   80105af0 <uartintr>
    lapiceoi();
801058d5:	e8 a6 ce ff ff       	call   80102780 <lapiceoi>
    break;
...
801058e7:	e8 94 dd ff ff       	call   80103680 <cpuid>
801058ec:	c7 04 24 cc 76 10 80 	movl   $0x801076cc,(%esp)
...
801058ff:	e8 4c ad ff ff       	call   80100650 <cprintf>
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
80105904:	e8 77 ce ff ff       	call   80102780 <lapiceoi>
    break;
...
80105949:	83 c4 3c             	add    $0x3c,%esp
8010594c:	5b                   	pop    %ebx
8010594d:	5e                   	pop    %esi
8010594e:	5f                   	pop    %edi
8010594f:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
80105950:	e9 7b e1 ff ff       	jmp    80103ad0 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
80105958:	e8 73 e1 ff ff       	call   80103ad0 <exit>
8010595d:	eb cd                	jmp    8010592c <trap+0x1cc>
8010595f:	90                   	nop
  }
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
80105960:	c7 04 24 80 4e 11 80 	movl   $0x80114e80,(%esp)
80105967:	e8 74 ea ff ff       	call   801043e0 <acquire>
      ticks++;
      wakeup(&ticks);
8010596c:	c7 04 24 c0 56 11 80 	movl   $0x801156c0,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
80105973:	83 05 c0 56 11 80 01 	addl   $0x1,0x801156c0
      wakeup(&ticks);
8010597a:	e8 61 e4 ff ff       	call   80103de0 <wakeup>
      release(&tickslock);
8010597f:	c7 04 24 80 4e 11 80 	movl   $0x80114e80,(%esp)
80105986:	e8 c5 ea ff ff       	call   80104450 <release>
8010598b:	e9 1d ff ff ff       	jmp    801058ad <trap+0x14d>
...
80105996:	e8 e5 dc ff ff       	call   80103680 <cpuid>
...
801059aa:	c7 04 24 f0 76 10 80 	movl   $0x801076f0,(%esp)
801059b1:	89 44 24 04          	mov    %eax,0x4(%esp)
801059b5:	e8 96 ac ff ff       	call   80100650 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
801059ba:	c7 04 24 c5 76 10 80 	movl   $0x801076c5,(%esp)
...
80105ab7:	00 
  ...
  for(p="xv6...\n"; *p; p++)
80105ab8:	bb e8 77 10 80       	mov    $0x801077e8,%ebx
...
80105b06:	6a 00                	push   $0x0
  jmp alltraps
80105b08:	e9 53 fb ff ff       	jmp    80105660 <alltraps>
...
80105b0f:	6a 01                	push   $0x1
  jmp alltraps
80105b11:	e9 4a fb ff ff       	jmp    80105660 <alltraps>
...
80105b18:	6a 02                	push   $0x2
  jmp alltraps
80105b1a:	e9 41 fb ff ff       	jmp    80105660 <alltraps>
...
80105b21:	6a 03                	push   $0x3
  jmp alltraps
80105b23:	e9 38 fb ff ff       	jmp    80105660 <alltraps>
...
80105b2a:	6a 04                	push   $0x4
  jmp alltraps
80105b2c:	e9 2f fb ff ff       	jmp    80105660 <alltraps>
...
80105b33:	6a 05                	push   $0x5
  jmp alltraps
80105b35:	e9 26 fb ff ff       	jmp    80105660 <alltraps>
...
80105b3c:	6a 06                	push   $0x6
  jmp alltraps
80105b3e:	e9 1d fb ff ff       	jmp    80105660 <alltraps>
...
80105b45:	6a 07                	push   $0x7
  jmp alltraps
80105b47:	e9 14 fb ff ff       	jmp    80105660 <alltraps>
...
80105b4c:	6a 08                	push   $0x8
  jmp alltraps
80105b4e:	e9 0d fb ff ff       	jmp    80105660 <alltraps>
...
80105b55:	6a 09                	push   $0x9
  jmp alltraps
80105b57:	e9 04 fb ff ff       	jmp    80105660 <alltraps>
...
80105b5c:	6a 0a                	push   $0xa
  jmp alltraps
80105b5e:	e9 fd fa ff ff       	jmp    80105660 <alltraps>
...
80105b63:	6a 0b                	push   $0xb
  jmp alltraps
80105b65:	e9 f6 fa ff ff       	jmp    80105660 <alltraps>
...
80105b6a:	6a 0c                	push   $0xc
  jmp alltraps
80105b6c:	e9 ef fa ff ff       	jmp    80105660 <alltraps>
...
80105b71:	6a 0d                	push   $0xd
  jmp alltraps
80105b73:	e9 e8 fa ff ff       	jmp    80105660 <alltraps>
...
80105b78:	6a 0e                	push   $0xe
  jmp alltraps
80105b7a:	e9 e1 fa ff ff       	jmp    80105660 <alltraps>
...
80105b81:	6a 0f                	push   $0xf
  jmp alltraps
80105b83:	e9 d8 fa ff ff       	jmp    80105660 <alltraps>
...
80105b8a:	6a 10                	push   $0x10
  jmp alltraps
80105b8c:	e9 cf fa ff ff       	jmp    80105660 <alltraps>
...
80105b91:	6a 11                	push   $0x11
  jmp alltraps
80105b93:	e9 c8 fa ff ff       	jmp    80105660 <alltraps>
...
80105b9a:	6a 12                	push   $0x12
  jmp alltraps
80105b9c:	e9 bf fa ff ff       	jmp    80105660 <alltraps>
...
80105ba3:	6a 13                	push   $0x13
  jmp alltraps
80105ba5:	e9 b6 fa ff ff       	jmp    80105660 <alltraps>
...
80105bac:	6a 14                	push   $0x14
  jmp alltraps
80105bae:	e9 ad fa ff ff       	jmp    80105660 <alltraps>
...
80105bb5:	6a 15                	push   $0x15
  jmp alltraps
80105bb7:	e9 a4 fa ff ff       	jmp    80105660 <alltraps>
...
80105bbe:	6a 16                	push   $0x16
  jmp alltraps
80105bc0:	e9 9b fa ff ff       	jmp    80105660 <alltraps>
...
80105bc7:	6a 17                	push   $0x17
  jmp alltraps
80105bc9:	e9 92 fa ff ff       	jmp    80105660 <alltraps>
...
80105bd0:	6a 18                	push   $0x18
  jmp alltraps
80105bd2:	e9 89 fa ff ff       	jmp    80105660 <alltraps>
...
80105bd9:	6a 19                	push   $0x19
  jmp alltraps
80105bdb:	e9 80 fa ff ff       	jmp    80105660 <alltraps>
...
80105be2:	6a 1a                	push   $0x1a
  jmp alltraps
80105be4:	e9 77 fa ff ff       	jmp    80105660 <alltraps>
...
80105beb:	6a 1b                	push   $0x1b
  jmp alltraps
80105bed:	e9 6e fa ff ff       	jmp    80105660 <alltraps>
...
80105bf4:	6a 1c                	push   $0x1c
  jmp alltraps
80105bf6:	e9 65 fa ff ff       	jmp    80105660 <alltraps>
...
80105bfd:	6a 1d                	push   $0x1d
  jmp alltraps
80105bff:	e9 5c fa ff ff       	jmp    80105660 <alltraps>
...
80105c06:	6a 1e                	push   $0x1e
  jmp alltraps
80105c08:	e9 53 fa ff ff       	jmp    80105660 <alltraps>
...
80105c0f:	6a 1f                	push   $0x1f
  jmp alltraps
80105c11:	e9 4a fa ff ff       	jmp    80105660 <alltraps>
...
80105c18:	6a 20                	push   $0x20
  jmp alltraps
80105c1a:	e9 41 fa ff ff       	jmp    80105660 <alltraps>
...
80105c21:	6a 21                	push   $0x21
  jmp alltraps
80105c23:	e9 38 fa ff ff       	jmp    80105660 <alltraps>
...
80105c2a:	6a 22                	push   $0x22
  jmp alltraps
80105c2c:	e9 2f fa ff ff       	jmp    80105660 <alltraps>
...
80105c33:	6a 23                	push   $0x23
  jmp alltraps
80105c35:	e9 26 fa ff ff       	jmp    80105660 <alltraps>
...
80105c3c:	6a 24                	push   $0x24
  jmp alltraps
80105c3e:	e9 1d fa ff ff       	jmp    80105660 <alltraps>
...
80105c45:	6a 25                	push   $0x25
  jmp alltraps
80105c47:	e9 14 fa ff ff       	jmp    80105660 <alltraps>
...
80105c4e:	6a 26                	push   $0x26
  jmp alltraps
80105c50:	e9 0b fa ff ff       	jmp    80105660 <alltraps>
...
80105c57:	6a 27                	push   $0x27
  jmp alltraps
80105c59:	e9 02 fa ff ff       	jmp    80105660 <alltraps>
...
80105c60:	6a 28                	push   $0x28
  jmp alltraps
80105c62:	e9 f9 f9 ff ff       	jmp    80105660 <alltraps>
...
80105c69:	6a 29                	push   $0x29
  jmp alltraps
80105c6b:	e9 f0 f9 ff ff       	jmp    80105660 <alltraps>
...
80105c72:	6a 2a                	push   $0x2a
  jmp alltraps
80105c74:	e9 e7 f9 ff ff       	jmp    80105660 <alltraps>
...
80105c7b:	6a 2b                	push   $0x2b
  jmp alltraps
80105c7d:	e9 de f9 ff ff       	jmp    80105660 <alltraps>
...
80105c84:	6a 2c                	push   $0x2c
  jmp alltraps
80105c86:	e9 d5 f9 ff ff       	jmp    80105660 <alltraps>
...
80105c8d:	6a 2d                	push   $0x2d
  jmp alltraps
80105c8f:	e9 cc f9 ff ff       	jmp    80105660 <alltraps>
...
80105c96:	6a 2e                	push   $0x2e
  jmp alltraps
80105c98:	e9 c3 f9 ff ff       	jmp    80105660 <alltraps>
...
80105c9f:	6a 2f                	push   $0x2f
  jmp alltraps
80105ca1:	e9 ba f9 ff ff       	jmp    80105660 <alltraps>
...
80105ca8:	6a 30                	push   $0x30
  jmp alltraps
80105caa:	e9 b1 f9 ff ff       	jmp    80105660 <alltraps>
...
80105cb1:	6a 31                	push   $0x31
  jmp alltraps
80105cb3:	e9 a8 f9 ff ff       	jmp    80105660 <alltraps>
...
80105cba:	6a 32                	push   $0x32
  jmp alltraps
80105cbc:	e9 9f f9 ff ff       	jmp    80105660 <alltraps>
...
80105cc3:	6a 33                	push   $0x33
  jmp alltraps
80105cc5:	e9 96 f9 ff ff       	jmp    80105660 <alltraps>
...
80105ccc:	6a 34                	push   $0x34
  jmp alltraps
80105cce:	e9 8d f9 ff ff       	jmp    80105660 <alltraps>
...
80105cd5:	6a 35                	push   $0x35
  jmp alltraps
80105cd7:	e9 84 f9 ff ff       	jmp    80105660 <alltraps>
...
80105cde:	6a 36                	push   $0x36
  jmp alltraps
80105ce0:	e9 7b f9 ff ff       	jmp    80105660 <alltraps>
...
80105ce7:	6a 37                	push   $0x37
  jmp alltraps
80105ce9:	e9 72 f9 ff ff       	jmp    80105660 <alltraps>
...
80105cf0:	6a 38                	push   $0x38
  jmp alltraps
80105cf2:	e9 69 f9 ff ff       	jmp    80105660 <alltraps>
...
80105cf9:	6a 39                	push   $0x39
  jmp alltraps
80105cfb:	e9 60 f9 ff ff       	jmp    80105660 <alltraps>
...
80105d02:	6a 3a                	push   $0x3a
  jmp alltraps
80105d04:	e9 57 f9 ff ff       	jmp    80105660 <alltraps>
...
80105d0b:	6a 3b                	push   $0x3b
  jmp alltraps
80105d0d:	e9 4e f9 ff ff       	jmp    80105660 <alltraps>
...
80105d14:	6a 3c                	push   $0x3c
  jmp alltraps
80105d16:	e9 45 f9 ff ff       	jmp    80105660 <alltraps>
...
80105d1d:	6a 3d                	push   $0x3d
  jmp alltraps
80105d1f:	e9 3c f9 ff ff       	jmp    80105660 <alltraps>
...
80105d26:	6a 3e                	push   $0x3e
  jmp alltraps
80105d28:	e9 33 f9 ff ff       	jmp    80105660 <alltraps>
...
80105d2f:	6a 3f                	push   $0x3f
  jmp alltraps
80105d31:	e9 2a f9 ff ff       	jmp    80105660 <alltraps>
...
80105d38:	6a 40                	push   $0x40
  jmp alltraps
80105d3a:	e9 21 f9 ff ff       	jmp    80105660 <alltraps>
...
80105d41:	6a 41                	push   $0x41
  jmp alltraps
80105d43:	e9 18 f9 ff ff       	jmp    80105660 <alltraps>
...
80105d4a:	6a 42                	push   $0x42
  jmp alltraps
80105d4c:	e9 0f f9 ff ff       	jmp    80105660 <alltraps>
...
80105d53:	6a 43                	push   $0x43
  jmp alltraps
80105d55:	e9 06 f9 ff ff       	jmp    80105660 <alltraps>
...
80105d5c:	6a 44                	push   $0x44
  jmp alltraps
80105d5e:	e9 fd f8 ff ff       	jmp    80105660 <alltraps>
...
80105d65:	6a 45                	push   $0x45
  jmp alltraps
80105d67:	e9 f4 f8 ff ff       	jmp    80105660 <alltraps>
...
80105d6e:	6a 46                	push   $0x46
  jmp alltraps
80105d70:	e9 eb f8 ff ff       	jmp    80105660 <alltraps>
...
80105d77:	6a 47                	push   $0x47
  jmp alltraps
80105d79:	e9 e2 f8 ff ff       	jmp    80105660 <alltraps>
...
80105d80:	6a 48                	push   $0x48
  jmp alltraps
80105d82:	e9 d9 f8 ff ff       	jmp    80105660 <alltraps>
...
80105d89:	6a 49                	push   $0x49
  jmp alltraps
80105d8b:	e9 d0 f8 ff ff       	jmp    80105660 <alltraps>
...
80105d92:	6a 4a                	push   $0x4a
  jmp alltraps
80105d94:	e9 c7 f8 ff ff       	jmp    80105660 <alltraps>
...
80105d9b:	6a 4b                	push   $0x4b
  jmp alltraps
80105d9d:	e9 be f8 ff ff       	jmp    80105660 <alltraps>
...
80105da4:	6a 4c                	push   $0x4c
  jmp alltraps
80105da6:	e9 b5 f8 ff ff       	jmp    80105660 <alltraps>
...
80105dad:	6a 4d                	push   $0x4d
  jmp alltraps
80105daf:	e9 ac f8 ff ff       	jmp    80105660 <alltraps>
...
80105db6:	6a 4e                	push   $0x4e
  jmp alltraps
80105db8:	e9 a3 f8 ff ff       	jmp    80105660 <alltraps>
...
80105dbf:	6a 4f                	push   $0x4f
  jmp alltraps
80105dc1:	e9 9a f8 ff ff       	jmp    80105660 <alltraps>
...
80105dc8:	6a 50                	push   $0x50
  jmp alltraps
80105dca:	e9 91 f8 ff ff       	jmp    80105660 <alltraps>
...
80105dd1:	6a 51                	push   $0x51
  jmp alltraps
80105dd3:	e9 88 f8 ff ff       	jmp    80105660 <alltraps>
...
80105dda:	6a 52                	push   $0x52
  jmp alltraps
80105ddc:	e9 7f f8 ff ff       	jmp    80105660 <alltraps>
...
80105de3:	6a 53                	push   $0x53
  jmp alltraps
80105de5:	e9 76 f8 ff ff       	jmp    80105660 <alltraps>
...
80105dec:	6a 54                	push   $0x54
  jmp alltraps
80105dee:	e9 6d f8 ff ff       	jmp    80105660 <alltraps>
...
80105df5:	6a 55                	push   $0x55
  jmp alltraps
80105df7:	e9 64 f8 ff ff       	jmp    80105660 <alltraps>
...
80105dfe:	6a 56                	push   $0x56
  jmp alltraps
80105e00:	e9 5b f8 ff ff       	jmp    80105660 <alltraps>
...
80105e07:	6a 57                	push   $0x57
  jmp alltraps
80105e09:	e9 52 f8 ff ff       	jmp    80105660 <alltraps>
...
80105e10:	6a 58                	push   $0x58
  jmp alltraps
80105e12:	e9 49 f8 ff ff       	jmp    80105660 <alltraps>
...
80105e19:	6a 59                	push   $0x59
  jmp alltraps
80105e1b:	e9 40 f8 ff ff       	jmp    80105660 <alltraps>
...
80105e22:	6a 5a                	push   $0x5a
  jmp alltraps
80105e24:	e9 37 f8 ff ff       	jmp    80105660 <alltraps>
...
80105e2b:	6a 5b                	push   $0x5b
  jmp alltraps
80105e2d:	e9 2e f8 ff ff       	jmp    80105660 <alltraps>
...
80105e34:	6a 5c                	push   $0x5c
  jmp alltraps
80105e36:	e9 25 f8 ff ff       	jmp    80105660 <alltraps>
...
80105e3d:	6a 5d                	push   $0x5d
  jmp alltraps
80105e3f:	e9 1c f8 ff ff       	jmp    80105660 <alltraps>
...
80105e46:	6a 5e                	push   $0x5e
  jmp alltraps
80105e48:	e9 13 f8 ff ff       	jmp    80105660 <alltraps>
...
80105e4f:	6a 5f                	push   $0x5f
  jmp alltraps
80105e51:	e9 0a f8 ff ff       	jmp    80105660 <alltraps>
...
80105e58:	6a 60                	push   $0x60
  jmp alltraps
80105e5a:	e9 01 f8 ff ff       	jmp    80105660 <alltraps>
...
80105e61:	6a 61                	push   $0x61
  jmp alltraps
80105e63:	e9 f8 f7 ff ff       	jmp    80105660 <alltraps>
...
80105e6a:	6a 62                	push   $0x62
  jmp alltraps
80105e6c:	e9 ef f7 ff ff       	jmp    80105660 <alltraps>
...
80105e73:	6a 63                	push   $0x63
  jmp alltraps
80105e75:	e9 e6 f7 ff ff       	jmp    80105660 <alltraps>
...
80105e7c:	6a 64                	push   $0x64
  jmp alltraps
80105e7e:	e9 dd f7 ff ff       	jmp    80105660 <alltraps>
...
80105e85:	6a 65                	push   $0x65
  jmp alltraps
80105e87:	e9 d4 f7 ff ff       	jmp    80105660 <alltraps>
...
80105e8e:	6a 66                	push   $0x66
  jmp alltraps
80105e90:	e9 cb f7 ff ff       	jmp    80105660 <alltraps>
...
80105e97:	6a 67                	push   $0x67
  jmp alltraps
80105e99:	e9 c2 f7 ff ff       	jmp    80105660 <alltraps>
...
80105ea0:	6a 68                	push   $0x68
  jmp alltraps
80105ea2:	e9 b9 f7 ff ff       	jmp    80105660 <alltraps>
...
80105ea9:	6a 69                	push   $0x69
  jmp alltraps
80105eab:	e9 b0 f7 ff ff       	jmp    80105660 <alltraps>
...
80105eb2:	6a 6a                	push   $0x6a
  jmp alltraps
80105eb4:	e9 a7 f7 ff ff       	jmp    80105660 <alltraps>
...
80105ebb:	6a 6b                	push   $0x6b
  jmp alltraps
80105ebd:	e9 9e f7 ff ff       	jmp    80105660 <alltraps>
...
80105ec4:	6a 6c                	push   $0x6c
  jmp alltraps
80105ec6:	e9 95 f7 ff ff       	jmp    80105660 <alltraps>
...
80105ecd:	6a 6d                	push   $0x6d
  jmp alltraps
80105ecf:	e9 8c f7 ff ff       	jmp    80105660 <alltraps>
...
80105ed6:	6a 6e                	push   $0x6e
  jmp alltraps
80105ed8:	e9 83 f7 ff ff       	jmp    80105660 <alltraps>
...
80105edf:	6a 6f                	push   $0x6f
  jmp alltraps
80105ee1:	e9 7a f7 ff ff       	jmp    80105660 <alltraps>
...
80105ee8:	6a 70                	push   $0x70
  jmp alltraps
80105eea:	e9 71 f7 ff ff       	jmp    80105660 <alltraps>
...
80105ef1:	6a 71                	push   $0x71
  jmp alltraps
80105ef3:	e9 68 f7 ff ff       	jmp    80105660 <alltraps>
...
80105efa:	6a 72                	push   $0x72
  jmp alltraps
80105efc:	e9 5f f7 ff ff       	jmp    80105660 <alltraps>
...
80105f03:	6a 73                	push   $0x73
  jmp alltraps
80105f05:	e9 56 f7 ff ff       	jmp    80105660 <alltraps>
...
80105f0c:	6a 74                	push   $0x74
  jmp alltraps
80105f0e:	e9 4d f7 ff ff       	jmp    80105660 <alltraps>
...
80105f15:	6a 75                	push   $0x75
  jmp alltraps
80105f17:	e9 44 f7 ff ff       	jmp    80105660 <alltraps>
...
80105f1e:	6a 76                	push   $0x76
  jmp alltraps
80105f20:	e9 3b f7 ff ff       	jmp    80105660 <alltraps>
...
80105f27:	6a 77                	push   $0x77
  jmp alltraps
80105f29:	e9 32 f7 ff ff       	jmp    80105660 <alltraps>
...
80105f30:	6a 78                	push   $0x78
  jmp alltraps
80105f32:	e9 29 f7 ff ff       	jmp    80105660 <alltraps>
...
80105f39:	6a 79                	push   $0x79
  jmp alltraps
80105f3b:	e9 20 f7 ff ff       	jmp    80105660 <alltraps>
...
80105f42:	6a 7a                	push   $0x7a
  jmp alltraps
80105f44:	e9 17 f7 ff ff       	jmp    80105660 <alltraps>
...
80105f4b:	6a 7b                	push   $0x7b
  jmp alltraps
80105f4d:	e9 0e f7 ff ff       	jmp    80105660 <alltraps>
...
80105f54:	6a 7c                	push   $0x7c
  jmp alltraps
80105f56:	e9 05 f7 ff ff       	jmp    80105660 <alltraps>
...
80105f5d:	6a 7d                	push   $0x7d
  jmp alltraps
80105f5f:	e9 fc f6 ff ff       	jmp    80105660 <alltraps>
...
80105f66:	6a 7e                	push   $0x7e
  jmp alltraps
80105f68:	e9 f3 f6 ff ff       	jmp    80105660 <alltraps>
...
80105f6f:	6a 7f                	push   $0x7f
  jmp alltraps
80105f71:	e9 ea f6 ff ff       	jmp    80105660 <alltraps>
...
80105f78:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105f7d:	e9 de f6 ff ff       	jmp    80105660 <alltraps>
...
80105f84:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105f89:	e9 d2 f6 ff ff       	jmp    80105660 <alltraps>
...
80105f90:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105f95:	e9 c6 f6 ff ff       	jmp    80105660 <alltraps>
...
80105f9c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105fa1:	e9 ba f6 ff ff       	jmp    80105660 <alltraps>
...
80105fa8:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105fad:	e9 ae f6 ff ff       	jmp    80105660 <alltraps>
...
80105fb4:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105fb9:	e9 a2 f6 ff ff       	jmp    80105660 <alltraps>
...
80105fc0:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105fc5:	e9 96 f6 ff ff       	jmp    80105660 <alltraps>
...
80105fcc:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105fd1:	e9 8a f6 ff ff       	jmp    80105660 <alltraps>
...
80105fd8:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105fdd:	e9 7e f6 ff ff       	jmp    80105660 <alltraps>
...
80105fe4:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105fe9:	e9 72 f6 ff ff       	jmp    80105660 <alltraps>
...
80105ff0:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105ff5:	e9 66 f6 ff ff       	jmp    80105660 <alltraps>
...
80105ffc:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106001:	e9 5a f6 ff ff       	jmp    80105660 <alltraps>
...
80106008:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010600d:	e9 4e f6 ff ff       	jmp    80105660 <alltraps>
...
80106014:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106019:	e9 42 f6 ff ff       	jmp    80105660 <alltraps>
...
80106020:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106025:	e9 36 f6 ff ff       	jmp    80105660 <alltraps>
...
8010602c:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106031:	e9 2a f6 ff ff       	jmp    80105660 <alltraps>
...
80106038:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010603d:	e9 1e f6 ff ff       	jmp    80105660 <alltraps>
...
80106044:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106049:	e9 12 f6 ff ff       	jmp    80105660 <alltraps>
...
80106050:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106055:	e9 06 f6 ff ff       	jmp    80105660 <alltraps>
...
8010605c:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106061:	e9 fa f5 ff ff       	jmp    80105660 <alltraps>
...
80106068:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010606d:	e9 ee f5 ff ff       	jmp    80105660 <alltraps>
...
80106074:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80106079:	e9 e2 f5 ff ff       	jmp    80105660 <alltraps>
...
80106080:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106085:	e9 d6 f5 ff ff       	jmp    80105660 <alltraps>
...
8010608c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106091:	e9 ca f5 ff ff       	jmp    80105660 <alltraps>
...
80106098:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010609d:	e9 be f5 ff ff       	jmp    80105660 <alltraps>
...
801060a4:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801060a9:	e9 b2 f5 ff ff       	jmp    80105660 <alltraps>
...
801060b0:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801060b5:	e9 a6 f5 ff ff       	jmp    80105660 <alltraps>
...
801060bc:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801060c1:	e9 9a f5 ff ff       	jmp    80105660 <alltraps>
...
801060c8:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801060cd:	e9 8e f5 ff ff       	jmp    80105660 <alltraps>
...
801060d4:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801060d9:	e9 82 f5 ff ff       	jmp    80105660 <alltraps>
...
801060e0:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801060e5:	e9 76 f5 ff ff       	jmp    80105660 <alltraps>
...
801060ec:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801060f1:	e9 6a f5 ff ff       	jmp    80105660 <alltraps>
...
801060f8:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801060fd:	e9 5e f5 ff ff       	jmp    80105660 <alltraps>
...
80106104:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80106109:	e9 52 f5 ff ff       	jmp    80105660 <alltraps>
...
80106110:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106115:	e9 46 f5 ff ff       	jmp    80105660 <alltraps>
...
8010611c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106121:	e9 3a f5 ff ff       	jmp    80105660 <alltraps>
...
80106128:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010612d:	e9 2e f5 ff ff       	jmp    80105660 <alltraps>
...
80106134:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80106139:	e9 22 f5 ff ff       	jmp    80105660 <alltraps>
...
80106140:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106145:	e9 16 f5 ff ff       	jmp    80105660 <alltraps>
...
8010614c:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106151:	e9 0a f5 ff ff       	jmp    80105660 <alltraps>
...
80106158:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010615d:	e9 fe f4 ff ff       	jmp    80105660 <alltraps>
...
80106164:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80106169:	e9 f2 f4 ff ff       	jmp    80105660 <alltraps>
...
80106170:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106175:	e9 e6 f4 ff ff       	jmp    80105660 <alltraps>
...
8010617c:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106181:	e9 da f4 ff ff       	jmp    80105660 <alltraps>
...
80106188:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010618d:	e9 ce f4 ff ff       	jmp    80105660 <alltraps>
...
80106194:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106199:	e9 c2 f4 ff ff       	jmp    80105660 <alltraps>
...
801061a0:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801061a5:	e9 b6 f4 ff ff       	jmp    80105660 <alltraps>
...
801061ac:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801061b1:	e9 aa f4 ff ff       	jmp    80105660 <alltraps>
...
801061b8:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801061bd:	e9 9e f4 ff ff       	jmp    80105660 <alltraps>
...
801061c4:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801061c9:	e9 92 f4 ff ff       	jmp    80105660 <alltraps>
...
801061d0:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801061d5:	e9 86 f4 ff ff       	jmp    80105660 <alltraps>
...
801061dc:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801061e1:	e9 7a f4 ff ff       	jmp    80105660 <alltraps>
...
801061e8:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801061ed:	e9 6e f4 ff ff       	jmp    80105660 <alltraps>
...
801061f4:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801061f9:	e9 62 f4 ff ff       	jmp    80105660 <alltraps>
...
80106200:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106205:	e9 56 f4 ff ff       	jmp    80105660 <alltraps>
...
8010620c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106211:	e9 4a f4 ff ff       	jmp    80105660 <alltraps>
...
80106218:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010621d:	e9 3e f4 ff ff       	jmp    80105660 <alltraps>
...
80106224:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106229:	e9 32 f4 ff ff       	jmp    80105660 <alltraps>
...
80106230:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106235:	e9 26 f4 ff ff       	jmp    80105660 <alltraps>
...
8010623c:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106241:	e9 1a f4 ff ff       	jmp    80105660 <alltraps>
...
80106248:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010624d:	e9 0e f4 ff ff       	jmp    80105660 <alltraps>
...
80106254:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106259:	e9 02 f4 ff ff       	jmp    80105660 <alltraps>
...
80106260:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106265:	e9 f6 f3 ff ff       	jmp    80105660 <alltraps>
...
8010626c:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106271:	e9 ea f3 ff ff       	jmp    80105660 <alltraps>
...
80106278:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010627d:	e9 de f3 ff ff       	jmp    80105660 <alltraps>
...
80106284:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106289:	e9 d2 f3 ff ff       	jmp    80105660 <alltraps>
...
80106290:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106295:	e9 c6 f3 ff ff       	jmp    80105660 <alltraps>
...
8010629c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801062a1:	e9 ba f3 ff ff       	jmp    80105660 <alltraps>
...
801062a8:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801062ad:	e9 ae f3 ff ff       	jmp    80105660 <alltraps>
...
801062b4:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801062b9:	e9 a2 f3 ff ff       	jmp    80105660 <alltraps>
...
801062c0:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801062c5:	e9 96 f3 ff ff       	jmp    80105660 <alltraps>
...
801062cc:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801062d1:	e9 8a f3 ff ff       	jmp    80105660 <alltraps>
...
801062d8:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801062dd:	e9 7e f3 ff ff       	jmp    80105660 <alltraps>
...
801062e4:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801062e9:	e9 72 f3 ff ff       	jmp    80105660 <alltraps>
...
801062f0:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801062f5:	e9 66 f3 ff ff       	jmp    80105660 <alltraps>
...
801062fc:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106301:	e9 5a f3 ff ff       	jmp    80105660 <alltraps>
...
80106308:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010630d:	e9 4e f3 ff ff       	jmp    80105660 <alltraps>
...
80106314:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106319:	e9 42 f3 ff ff       	jmp    80105660 <alltraps>
...
80106320:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106325:	e9 36 f3 ff ff       	jmp    80105660 <alltraps>
...
8010632c:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106331:	e9 2a f3 ff ff       	jmp    80105660 <alltraps>
...
80106338:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010633d:	e9 1e f3 ff ff       	jmp    80105660 <alltraps>
...
80106344:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106349:	e9 12 f3 ff ff       	jmp    80105660 <alltraps>
...
80106350:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106355:	e9 06 f3 ff ff       	jmp    80105660 <alltraps>
...
8010635c:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106361:	e9 fa f2 ff ff       	jmp    80105660 <alltraps>
...
80106368:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010636d:	e9 ee f2 ff ff       	jmp    80105660 <alltraps>
...
80106374:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106379:	e9 e2 f2 ff ff       	jmp    80105660 <alltraps>
...
80106380:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106385:	e9 d6 f2 ff ff       	jmp    80105660 <alltraps>
...
8010638c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106391:	e9 ca f2 ff ff       	jmp    80105660 <alltraps>
...
80106398:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010639d:	e9 be f2 ff ff       	jmp    80105660 <alltraps>
...
801063a4:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801063a9:	e9 b2 f2 ff ff       	jmp    80105660 <alltraps>
...
801063b0:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801063b5:	e9 a6 f2 ff ff       	jmp    80105660 <alltraps>
...
801063bc:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801063c1:	e9 9a f2 ff ff       	jmp    80105660 <alltraps>
...
801063c8:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801063cd:	e9 8e f2 ff ff       	jmp    80105660 <alltraps>
...
801063d4:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801063d9:	e9 82 f2 ff ff       	jmp    80105660 <alltraps>
...
801063e0:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801063e5:	e9 76 f2 ff ff       	jmp    80105660 <alltraps>
...
801063ec:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801063f1:	e9 6a f2 ff ff       	jmp    80105660 <alltraps>
...
801063f8:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801063fd:	e9 5e f2 ff ff       	jmp    80105660 <alltraps>
...
80106404:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106409:	e9 52 f2 ff ff       	jmp    80105660 <alltraps>
...
80106410:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106415:	e9 46 f2 ff ff       	jmp    80105660 <alltraps>
...
8010641c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106421:	e9 3a f2 ff ff       	jmp    80105660 <alltraps>
...
80106428:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010642d:	e9 2e f2 ff ff       	jmp    80105660 <alltraps>
...
80106434:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106439:	e9 22 f2 ff ff       	jmp    80105660 <alltraps>
...
80106440:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106445:	e9 16 f2 ff ff       	jmp    80105660 <alltraps>
...
8010644c:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106451:	e9 0a f2 ff ff       	jmp    80105660 <alltraps>
...
80106458:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010645d:	e9 fe f1 ff ff       	jmp    80105660 <alltraps>
...
80106464:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106469:	e9 f2 f1 ff ff       	jmp    80105660 <alltraps>
...
80106470:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106475:	e9 e6 f1 ff ff       	jmp    80105660 <alltraps>
...
8010647c:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106481:	e9 da f1 ff ff       	jmp    80105660 <alltraps>
...
80106488:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010648d:	e9 ce f1 ff ff       	jmp    80105660 <alltraps>
...
80106494:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106499:	e9 c2 f1 ff ff       	jmp    80105660 <alltraps>
...
801064a0:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801064a5:	e9 b6 f1 ff ff       	jmp    80105660 <alltraps>
...
801064ac:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801064b1:	e9 aa f1 ff ff       	jmp    80105660 <alltraps>
...
801064b8:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801064bd:	e9 9e f1 ff ff       	jmp    80105660 <alltraps>
...
801064c4:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801064c9:	e9 92 f1 ff ff       	jmp    80105660 <alltraps>
...
801064d0:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801064d5:	e9 86 f1 ff ff       	jmp    80105660 <alltraps>
...
801064dc:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801064e1:	e9 7a f1 ff ff       	jmp    80105660 <alltraps>
...
801064e8:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801064ed:	e9 6e f1 ff ff       	jmp    80105660 <alltraps>
...
801064f4:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801064f9:	e9 62 f1 ff ff       	jmp    80105660 <alltraps>
...
80106500:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106505:	e9 56 f1 ff ff       	jmp    80105660 <alltraps>
...
8010650c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106511:	e9 4a f1 ff ff       	jmp    80105660 <alltraps>
...
80106518:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010651d:	e9 3e f1 ff ff       	jmp    80105660 <alltraps>
...
80106524:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106529:	e9 32 f1 ff ff       	jmp    80105660 <alltraps>
...
80106530:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106535:	e9 26 f1 ff ff       	jmp    80105660 <alltraps>
...
8010653c:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106541:	e9 1a f1 ff ff       	jmp    80105660 <alltraps>
...
80106548:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010654d:	e9 0e f1 ff ff       	jmp    80105660 <alltraps>
...
80106554:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106559:	e9 02 f1 ff ff       	jmp    80105660 <alltraps>
...
80106560:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106565:	e9 f6 f0 ff ff       	jmp    80105660 <alltraps>
...
8010656c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106571:	e9 ea f0 ff ff       	jmp    80105660 <alltraps>
...
801065e2:	e8 b9 de ff ff       	call   801044a0 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106681:	c3                   	ret    
  ...
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
80106682:	c7 04 24 f0 77 10 80 	movl   $0x801077f0,(%esp)
...
80106733:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
80106736:	e8 45 cf ff ff       	call   80103680 <cpuid>
...
801067f0:	a1 c4 56 11 80       	mov    0x801156c4,%eax
...
80106834:	0f 84 c3 00 00 00    	je     801068fd <switchuvm+0xed>
  ...
  pushcli();
8010683a:	e8 b1 da ff ff       	call   801042f0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010683f:	e8 bc cd ff ff       	call   80103600 <mycpu>
80106844:	89 c3                	mov    %eax,%ebx
80106846:	e8 b5 cd ff ff       	call   80103600 <mycpu>
8010684b:	89 c7                	mov    %eax,%edi
8010684d:	e8 ae cd ff ff       	call   80103600 <mycpu>
80106852:	83 c7 08             	add    $0x8,%edi
80106855:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106858:	e8 a3 cd ff ff       	call   80103600 <mycpu>
...
80106899:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
8010689e:	e8 5d cd ff ff       	call   80103600 <mycpu>
801068a3:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
801068aa:	e8 51 cd ff ff       	call   80103600 <mycpu>
801068af:	b9 10 00 00 00       	mov    $0x10,%ecx
801068b4:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
801068b8:	e8 43 cd ff ff       	call   80103600 <mycpu>
...
801068c6:	89 48 0c             	mov    %ecx,0xc(%eax)
  ...
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
801068c9:	e8 32 cd ff ff       	call   80103600 <mycpu>
...
801068eb:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
801068ec:	e9 3f da ff ff       	jmp    80104330 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
801068f1:	c7 04 24 f6 77 10 80 	movl   $0x801077f6,(%esp)
801068f8:	e8 63 9a ff ff       	call   80100360 <panic>
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
801068fd:	c7 04 24 21 78 10 80 	movl   $0x80107821,(%esp)
...
switchuvm(struct proc *p)
{
  ...
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
80106909:	c7 04 24 0c 78 10 80 	movl   $0x8010780c,(%esp)
...
80106957:	e8 44 db ff ff       	call   801044a0 <memset>
...
8010698b:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
8010698c:	e9 af db ff ff       	jmp    80104540 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
80106991:	c7 04 24 35 78 10 80 	movl   $0x80107835,(%esp)
...
80106a41:	c3                   	ret    
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
80106a42:	c7 04 24 4f 78 10 80 	movl   $0x8010784f,(%esp)
80106a49:	e8 12 99 ff ff       	call   80100360 <panic>
{
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
80106a4e:	c7 04 24 f0 78 10 80 	movl   $0x801078f0,(%esp)
...
80106aa3:	e8 f8 d9 ff ff       	call   801044a0 <memset>
...
80106adf:	75 af                	jne    80106a90 <allocuvm+0x30>
      cprintf("allocuvm out of memory\n");
80106ae1:	c7 04 24 6d 78 10 80 	movl   $0x8010786d,(%esp)
...
80106b0a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
80106b10:	c7 04 24 85 78 10 80 	movl   $0x80107885,(%esp)
...
freevm(pde_t *pgdir)
{
  ...
  if(pgdir == 0)
    panic("freevm: no pgdir");
80106bd8:	c7 04 24 a1 78 10 80 	movl   $0x801078a1,(%esp)
...
80106c1b:	e8 80 d8 ff ff       	call   801044a0 <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
...
80106c8b:	a3 c4 56 11 80       	mov    %eax,0x801156c4
// Switch h/w page table register to the kernel-only page table,
// for when no process is running.
void
switchkvm(void)
...
80106cbb:	c3                   	ret    
{
  ...
  if(pte == 0)
    panic("clearpteu");
80106cbc:	c7 04 24 b2 78 10 80 	movl   $0x801078b2,(%esp)
...
80106d0d:	e8 2e d8 ff ff       	call   80104540 <memmove>
...
80106da4:	eb d8                	jmp    80106d7e <copyuvm+0xae>
  for(i = 0; i < sz; i += PGSIZE){
    ...
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
80106da6:	c7 04 24 d6 78 10 80 	movl   $0x801078d6,(%esp)
80106dad:	e8 ae 95 ff ff       	call   80100360 <panic>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
80106db2:	c7 04 24 bc 78 10 80 	movl   $0x801078bc,(%esp)
...
80106e3c:	e8 ff d6 ff ff       	call   80104540 <memmove>
    len -= n;
    buf += n;
