...
_scarlettest:     file format elf32-i386
...
main(int argc, char *argv[])
{
  ...
  enablecount();
   b:	e8 2a 03 00 00       	call   33a <enablecount>
  int myPID = getpid();
  10:	e8 fd 02 00 00       	call   312 <getpid>
  15:	89 c6                	mov    %eax,%esi
  int child_PID = fork();
  17:	e8 6e 02 00 00       	call   28a <fork>
  scarlet(myPID, 1234);
  1c:	c7 44 24 04 d2 04 00 	movl   $0x4d2,0x4(%esp)
  23:	00 
  24:	89 34 24             	mov    %esi,(%esp)
int
main(int argc, char *argv[])
{
  enablecount();
  ...
  scarlet(myPID, 1234);
  29:	e8 2c 03 00 00       	call   35a <scarlet>
  int y;
  if (child_PID == 0){
  ...
  32:	78 11                	js     45 <main+0x45>
	exit();
	}
  else {
	wait();
  34:	e8 61 02 00 00       	call   29a <wait>
  39:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
	}
  ps();
  40:	e8 0d 03 00 00       	call   352 <ps>
  exit();
  ...
  if (child_PID == 0){
	printf(2, "Child running \n");
  4a:	c7 44 24 04 76 07 00 	movl   $0x776,0x4(%esp)
  51:	00 
  52:	b3 33                	mov    $0x33,%bl
  54:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  5b:	e8 b0 03 00 00       	call   410 <printf>
  	for (y = 0; y <= 50; y++){
		ps();
  60:	e8 ed 02 00 00       	call   352 <ps>
  int child_PID = fork();
  scarlet(myPID, 1234);
  int y;
  if (child_PID == 0){
	printf(2, "Child running \n");
  	for (y = 0; y <= 50; y++){
  65:	83 eb 01             	sub    $0x1,%ebx
  68:	75 f6                	jne    60 <main+0x60>
  6a:	eb cd                	jmp    39 <main+0x39>
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
...
0000033a <enablecount>:
SYSCALL(enablecount)
 33a:	b8 17 00 00 00       	mov    $0x17,%eax
 33f:	cd 40                	int    $0x40
 341:	c3                   	ret    

00000342 <disablecount>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a9:	0f b6 92 8d 07 00 00 	movzbl 0x78d(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 53f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 541:	b8 86 07 00 00       	mov    $0x786,%eax
...
free(void *ap)
{
 ...
 601:	a1 08 0a 00 00       	mov    0xa08,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 647:	89 10                	mov    %edx,(%eax)
  freep = p;
 649:	a3 08 0a 00 00       	mov    %eax,0xa08
}
 64e:	5b                   	pop    %ebx
 64f:	5e                   	pop    %esi
 650:	5f                   	pop    %edi
 ...
 66f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 672:	a3 08 0a 00 00       	mov    %eax,0xa08
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 1d 08 0a 00 00    	mov    0xa08,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 6d9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6db:	3b 15 08 0a 00 00    	cmp    0xa08,%edx
...
morecore(uint nu)
{
 ...
 70d:	e8 ee fe ff ff       	call   600 <free>
  return freep;
 712:	8b 15 08 0a 00 00    	mov    0xa08,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 734:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 737:	89 15 08 0a 00 00    	mov    %edx,0xa08
      return (void*)(p + 1);
 ...
 74c:	eb e9                	jmp    737 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 74e:	c7 05 08 0a 00 00 0c 	movl   $0xa0c,0xa08
 755:	0a 00 00 
    base.s.size = 0;
 758:	ba 0c 0a 00 00       	mov    $0xa0c,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 75d:	c7 05 0c 0a 00 00 0c 	movl   $0xa0c,0xa0c
 764:	0a 00 00 
    base.s.size = 0;
 767:	c7 05 10 0a 00 00 00 	movl   $0x0,0xa10
 76e:	00 00 00 
